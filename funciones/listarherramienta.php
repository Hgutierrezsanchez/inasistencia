  ...
  <div class="box-tools">
    <table  class="table table-bordered table-striped" id="tbllistar2">
     <form name="formlistar2" action="" method="POST">
        <input type="submit" id="atrasreg"name="Submit" value="Atras "  onclick="cargardato() return false" a data-toggle="tab" href="#menu4">
            <tr>
            ...
            <?php
                ...
                $consulta3="Select tbldetreg.* ,tblherramientas.nombre from tbldetreg INNER JOIN tblherramientas ON tbldetreg.idherramienta=tblherramientas.idh where tbldetreg.iddetreg='$idregistro' order by tblherramientas.idh";
